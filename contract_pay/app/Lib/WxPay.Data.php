...
class WxPayDataBase
{
	...
	**/
    ...
    Log::info("SetSign value:" . json_encode($this->values));
		return $sign;
	}

	public function SetSign2($config)
	{
	...
	public function SetSign3($config)
	{
		$sign = $this->MakeSign($config);
...
class WxPayResults extends WxPayDataBase
{
	...
	public static function InitNoCheck($config, $xml)
	{	
		$obj = new self();
		$obj->FromXml($xml);
		//失败则直接返回失败
...
class WxClientpay extends WxPayDataBase {
  ...
  public function SePpartnerid($value) { $this->values['partnerid'] = $value;}
  public function SetAppid($value) { $this->values['appid'] = $value;}
  public function SetPrepayid($value) { $this->values['prepayid'] = $value;}
  public function SetPackage() { $this->values['package'] = "Sign=WXPay";}
  public function SetTimeStamp() { $this->values['timestamp'] = (int)time();}
  public function SetNonce_str() { $this->values['noncestr'] = self::getNonceStr();}
}

class WxJSpay extends WxClientpay {
  public function SetAppid($value) { $this->values['appId'] = $value;}
  public function SetJsPackage($value) { $this->values['package'] = "prepay_id=" . $value;}
  public function SetTimeStamp($value = "") { $this->values['timeStamp'] = $value ? $value : (int)time();}
  public function SetNonce_str($value = "") { $this->values['nonceStr'] = $value ? $value : self::getNonceStr();}
  public function SetSignType($value) { $this->values['signType'] = $value;}
}

class WxPaymentUser extends WxPayDataBase {
  public static function getNonceStr($length = 32) 
  {
    $chars = "abcdefghijklmnopqrstuvwxyz0123456789";  
    $str ="";
  ...
  public function SetMch_id($value) { $this->values['mchid'] = $value;}
  public function SetAppid($value) { $this->values['mch_appid'] = $value;}
  public function SetNonce_str() { $this->values['nonce_str'] = self::getNonceStr();}
  public function SetOut_trade_no($value) { $this->values['partner_trade_no'] = $value;}
  public function SetOpenid($value) { $this->values['openid'] = $value;}
  public function SetCheckname($value = false) { $this->values['check_name'] = $value ? "FORCE_CHECK" : "NO_CHECK";}
  public function SetRealName($value) { $this->values['re_user_name'] = $value;}
  public function SetAmount($value) { $this->values['amount'] = $value;}
  public function SetDesc($value) { $this->values['desc'] = $value;}
  public function SetSpbill_create_ip($value) { $this->values['spbill_create_ip'] = $value;}
}

class CashReadEnvelopes extends WxPayDataBase {
  public static function getNonceStr($length = 32) 
  {
    $chars = "abcdefghijklmnopqrstuvwxyz0123456789";  
    $str ="";
  ...
  public function SetNonce_str($value) { $this->values['nonce_str'] = $value;}
  public function SetMchBillNo($value) { $this->values['mch_billno'] = $value;}
  public function SetMch_id($value) { $this->values['mch_id'] = $value;}
  public function SetWxAppid($value) { $this->values['wxappid'] = $value;}
  public function SetMchName($value) { $this->values['send_name'] = $value;}
  public function SetOpenId($value) { $this->values['re_openid'] = $value;}
  public function SetAmount($value) { $this->values['total_amount'] = $value;}
  public function SetTotalNum() { $this->values['total_num'] = 1;}
  public function SetWishing($values) { $this->values['wishing'] = $values;}
  public function SetClientIp($values) { $this->values['client_ip'] = $values;}
  public function SetActName($values) { $this->values['act_name'] = $values;}
  public function SetRemark($values) { $this->values['remark'] = $values;}
}


class WxPayTransferinfo extends WxPayDataBase {
 public static function getNonceStr($length = 32) 
  {
    $chars = "abcdefghijklmnopqrstuvwxyz0123456789";  
    $str ="";
...
class WxPayGetCertficates extends WxPayDataBase {
  public static function getNonceStr($length = 32) 
  {
    $chars = "abcdefghijklmnopqrstuvwxyz0123456789";  
    $str ="";
...
class UploadFileTest extends WxPayDataBase {
  public $delimiter;
  public function SetMch_id($value) { $this->values['mch_id'] = $value;}
  public function SetMedia_hash($value) { $this->values['media_hash'] = $value;}

  // 签名后添加
  public function SetFileName($value) { $this->values['filename'] = $value;}
  public function SetFilelength($value) { $this->values['filelength'] = $value;}
  public function SetFile($value) { $this->values['upload'] = $value;}

  // 
  public function buildData($media){
    $data = '';
    $eol = "\r\n";
    ...
    $data .= "--" . $this->delimiter . $eol
      . 'Content-Disposition: form-data; name="media"; filename="' . $media['filename'] . '";' 
      . 'filelength="' . $media['filelength'] . '";'
      . 'content-type="image/jpg"'."\r\n\r\n";

    Log::info("buildData data:" . $data);
...
class WxPayDownloadBill extends WxPayDataBase
{
  ...
  public function SetAccountType($value) {$this->values['account_type'] = $value;}
}
